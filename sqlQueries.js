...
exports.INSERT_INTO_SEATS = "insert into Seats (id_hall, row, seat) values (?, ?, ?) ";
exports.INSERT_INTO_SHOWS = "insert into Shows (time, movie, hall) values (?, ?, ?) ";
...
exports.CREATE_HALLS_TABLE = "create table Halls (id INTEGER PRIMARY KEY AUTOINCREMENT, name text)";
exports.CREATE_SEATS_TABLE = "create table Seats (id INTEGER PRIMARY KEY AUTOINCREMENT, id_hall int, row int, seat int)";
exports.CREATE_SHOWS_TABLE = "create table Shows (id INTEGER PRIMARY KEY AUTOINCREMENT, time datetime, movie text, hall int)";
exports.CREATE_BOOKING_TABLE = "create table Booking (id INTEGER PRIMARY KEY AUTOINCREMENT, show int, seat int)";
